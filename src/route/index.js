...
router.get('/template-1 copy', function (req, res) {
  res.render('template-1 copy', {
    layout: 'template-1 copy',
    page: {
      title: 'Example Page',
    },
    header: [
...
// ================================================================
router.get('/template-2 copy', function (req, res) {
  res.render('template-2 copy', {
    layout: 'template-2 copy',
    page: {
      title: 'Example Page',
    },
    header: [
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/template-3 copy', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('template-3 copy', {
    page: {
      title: 'Example Page',
    },
    layout: 'template-3 copy',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/template-3_1', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('template-3_1', {
    page: {
      title: 'Example Page',
    },
    layout: 'template-3_1',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/template-5 copy', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('template-5 copy', {
    page: {
      title: 'Example Page',
    },
    layout: 'template-5 copy',
